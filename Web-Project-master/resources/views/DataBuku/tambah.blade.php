        ...
        <div class="hero rounded-3 px-5 pb-5 pt-5">
            <form enctype="multipart/form-data" action="/daftarbuku/simpan" method="post">
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="judul" id="judul" class="form-control" value="{{ old('judul') }}" autofocus autocomplete="off">
                </div>
                @error('judul')
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="penerbit" id="penerbit" class="form-control" value="{{ old('penerbit') }}" autocomplete="off">
                </div>
                @error('penerbit')
                    <div class="alert-danger mt-1">{{$message}}</div>
                @enderror
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="subjek" id="subjek" class="form-control" value="{{ old('subjek') }}" autocomplete="off">
                </div>
                @error('subjek')
                    <div class="alert-danger mt-1">{{$message}}</div>
                @enderror
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="kategori" id="kategori" class="form-control" value="{{ old('kategori') }}" autocomplete="off">
                </div>
                @error('kategori')
                    <div class="alert-danger mt-1">{{$message}}</div>
                @enderror
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="lokasi" id="lokasi" class="form-control" value="{{ old('lokasi') }}" autocomplete="off">
                </div>
                @error('lokasi')
                    <div class="alert-danger mt-1">{{$message}}</div>
                @enderror
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="jumlah_buku" id="jumlah_buku" class="form-control" value="{{ old('jumlah_buku') }}" autocomplete="off">
                </div>
                @error('jumlah_buku')
                    <div class="alert-danger mt-1">{{$message}}</div>
                @enderror
